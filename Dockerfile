...
# Install Jupyter Vim
RUN mkdir -p $(pipenv run jupyter --data-dir)/nbextensions/vim_binding \
    && pipenv run jupyter nbextension install https://raw.githubusercontent.com/lambdalisue/jupyter-vim-binding/master/vim_binding.js --nbextensions=$(pipenv run jupyter --data-dir)/nbextensions/vim_binding \
